import { DropdownList } from "../reuseables/DropdownList";
import { PayMethodCard } from "../reuseables/PayMethodCard";
import { PayMethodMail } from "../reuseables/PayMethodMail";
...
import { DownloadIcon } from "../reuseables/Icon";
...
const Settings = ({ setVisible }) => {
  return (
    <div
      className="px-4 flex-1 overflow-hidden bg-neutral-100"
